...
@dp.materialized_view(
    name=f"{catalog}.{gold_schema}.agg_pollution_hourly",
...
@dp.materialized_view(
    name=f"{catalog}.{gold_schema}.agg_pollution_hourly_by_city",
...
def hourly_bycity():
    df_measurements = spark.read.table(f"{catalog}.{gold_schema}.agg_pollution_hourly")
    return (
        df_measurements
        .select(
            "date_int",
